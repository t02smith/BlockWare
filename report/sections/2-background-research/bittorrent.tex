...
Without centralised architecture data will need to be distributed among the platform's users, where each user will only have the data they are interested in. This section will discuss the popular P2P file-sharing protocol BitTorrent and Section~\ref{sec:lit-p2p} will look at other examples.
\x
...
As such, it is important to understand what makes BitTorrent so successful and how I could extract key ideas in my project.
