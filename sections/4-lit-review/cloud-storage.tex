...
\begin{longtable}{ p{0.35\textwidth} p{0.6\textwidth} }
  ...
  \\\midrule\midrule
  \multicolumn{2}{c}{\cellcolor{pink!70}\textit{Built with Blockchain}}\\\midrule
  ...
  %
  \x
  \midrule\multicolumn{2}{c}{\cellcolor{cyan!40}\textit{Blockchain to Supplement a Cloud Platform}}\\\midrule
