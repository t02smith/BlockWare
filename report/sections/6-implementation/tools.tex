...
\begin{longtable}{p{0.15\textwidth} p{0.75\textwidth}}
  ...
  & \small Alchemy provides useful tools for interacting with Ethereum and specifically Sepolia, such as an ETH faucet and an RPC URL so I don't have to run my own Ethereum node.\\
