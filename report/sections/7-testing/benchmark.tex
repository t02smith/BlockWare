...
\vspace{-4mm}
\newparagraph
These results show that the download speed we can massively be increased by connecting to more peers. This shows that my application can correctly handle many concurrent peers \reqref{F-M7} and will distribute requests among many different connections to increase scalability \reqref{NF-S1}.
