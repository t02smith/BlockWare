...
\begin{longtable}{p{0.15\textwidth} p{0.75\textwidth}}
  ...
  & \small An Ethereum test-net that used to deploy my smart contract to. One of the main benefits was that it provides a fast transaction time for quick feedback. It was chosen over Goerli~\cite{noauthor_goerli_nodate} as the faucet gave out 5 times as much Ether.\\
