...
export function CancelDownload(arg1) {
  return window['go']['controller']['Controller']['CancelDownload'](arg1);
}

export function CheckForUpdates() {
  return window['go']['controller']['Controller']['CheckForUpdates']();
}
...
export function PauseDownload(arg1) {
  return window['go']['controller']['Controller']['PauseDownload'](arg1);
}
