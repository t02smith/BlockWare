...
\begin{enumerate}
  ...
  \item \textbf{Fail Fast} Automated tests should be run in a pipeline where the fastest tests are always run first to reduce the time spent running tests.
...
\begin{longtable}{p{0.15\textwidth} p{0.7\textwidth}}
  ...
  & This package is included as it provides several useful testing features that aren't present in the standard library package. This includes assert functions to boost code readability, mocking tools for better unit testing, setup/teardown functionality, and more.
